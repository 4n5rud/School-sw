...
const base = (d: React.ReactNode, viewBox = '0 0 24 24') =>
...
export const ChevronUpIcon = base(
...
export const BitcoinIcon = base(
  <>
    <path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L10.5 3.545m1.267 15.544-1.4-7.99m0 0c4.924.868 6.14-6.025 1.216-6.894m0 0L10.5 3.545M7.5 5.5l.5 3m.5 3 .5 3m0 0 .5 3" strokeWidth="1.5" />
    <path d="M7.5 4.5h3.75a2.25 2.25 0 0 1 0 4.5H7.5m0-4.5v4.5m0 0h4.5a2.25 2.25 0 0 1 0 4.5H7.5m0-4.5v4.5" strokeWidth="1.5" />
  </>
);

export const DiamondIcon = base(
...
export const Maximize2Icon = base(
  <>
